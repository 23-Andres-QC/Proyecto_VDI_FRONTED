          ...
          <div class="footer-section logo-info-section">
            ...
            <div class="social-section-integrated">
              ...
              <div class="social-icons">
                <!-- Instagram -->
                <a
                  href="https://www.instagram.com/uesan_oficial/?hl=es"
                  target="_blank"
                ...
                <!-- Facebook -->
                <a
                  href="https://www.facebook.com/uesan/?locale=es_LA"
                  target="_blank"
                ...
                <!-- LinkedIn -->
                <a
                  href="https://www.linkedin.com/school/universidad-esan/?originalSubdomain=pe"
                  target="_blank"
                ...
                <!-- X (Twitter) -->
                <a
                  href="https://x.com/universidadesan?lang=es"
                  target="_blank"
...
.social-section-integrated .social-icons {
  display: flex;
...
.social-section-integrated .social-icon {
  width: 40px;
  height: 40px;
...
.social-section-integrated .social-icon::before {
  content: '';
  position: absolute;
  top: 0;
  left: -100%;
...
.social-section-integrated .social-icon:hover::before {
  left: 0;
}

.social-section-integrated .social-icon:hover {
  transform: translateY(-2px) scale(1.05);
  box-shadow: 0 6px 15px rgba(0, 0, 0, 0.3);
}

.social-section-integrated .social-icon svg {
  width: 20px;
  height: 20px;
  fill: white;
  position: relative;
...
.social-section-integrated .social-icon.instagram::before {
  background: linear-gradient(45deg, #833ab4, #fd1d1d, #fcb045);
}

.social-section-integrated .social-icon.instagram:hover {
  border-color: #833ab4;
  box-shadow: 0 6px 15px rgba(131, 58, 180, 0.3);
}

.social-section-integrated .social-icon.facebook::before {
  background: linear-gradient(45deg, #1877f2, #42a5f5);
}

.social-section-integrated .social-icon.facebook:hover {
  border-color: #1877f2;
  box-shadow: 0 6px 15px rgba(24, 119, 242, 0.3);
}

.social-section-integrated .social-icon.linkedin::before {
  background: linear-gradient(45deg, #0077b5, #00a0dc);
}

.social-section-integrated .social-icon.linkedin:hover {
  border-color: #0077b5;
  box-shadow: 0 6px 15px rgba(0, 119, 181, 0.3);
}

.social-section-integrated .social-icon.twitter::before {
  background: linear-gradient(45deg, #000000, #333333);
}

.social-section-integrated .social-icon.twitter:hover {
  border-color: #000000;
  box-shadow: 0 6px 15px rgba(0, 0, 0, 0.3);
}
